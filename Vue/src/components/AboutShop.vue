<template>
  <div class="grid grid-cols-2 gap-10 w-full">
    <div class="bg-white font-sans" style="text-align: start">
      <h1 class="flex font-semibold mb-4 from-neutral-400">What is ShopME?</h1>
      <div class="flex border-2 rounded-md bg-slate-200">
        ...
        <img src="../assets/3561979.png" alt="" class="bg-white-200 w-1/4" />
      </div>
    </div>
    <div class="bg-white font-sans" style="text-align: start">
      <h1 class="flex font-semibold mb-4 from-neutral-400">What is ShopME?</h1>
