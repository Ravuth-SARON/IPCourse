<template>
  <form action="" @submit.prevent="placeOrder">
    ...
    >
      <a href="#" class="text-2xl font-bold text-gray-800">Shop ME</a>
        ...
        >
          ...
          >
            <img
              ...
              :src="getImage(item.product.image_path)"
              alt=""
            />
        ...
        <div class="mt-5 grid gap-6">
          ...
          <div class="relative">
            ...
            >
              ...
              />
              <div class="ml-5">
                <span class="mt-2 font-semibold">Vireak Buntham Delivery</span>
                <p class="text-slate-500 text-sm leading-6">
                  Delivery: 2-4 Days
                </p>
              </div>
          ...
          <div class="relative">
            <select
             ...
             >  
                ...
                <option value="CREDID">CREDIT</option>
                <option value="ACLEDA">ACELYDA</option>
...
export default {
    ...
    async placeOrder() {
      try {
        ...
        const orderData = {
          ...
          shipping_commune: this.shipping_commune,
        ...
        // Optionally, you can navigate the user to a success page or display a success message
      } catch (error) {
  ...
  async mounted() {
    try {
      ...
      const all= this.cartItems.reduce(
