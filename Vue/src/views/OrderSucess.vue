<template>
  ...
  <div class="container px-4 mx-auto">
    <div class="max-w-2xl mx-auto text-center">
      ...
      <span class="block mb-1 text-sm font-bold text-indigo-500">SUCCESS</span>
      <h3 class="text-2xl font-black mb-5">Your order has been placed</h3>
      <p class="text-lg font-bold mb-12">Thank You For Order our product, We will delivery your product as soon as possible.</p>
      <a class="group relative inline-block h-12 w-full xs:w-60 bg-blueGray-900 rounded-md" href="#">
        <div class="absolute top-0 left-0 transform -translate-y-1 -translate-x-1 w-full h-full group-hover:translate-y-0 group-hover:translate-x-0 transition duration-300">
          <router-link :to="{name:'newIn'}"  class="flex h-full w-full items-center justify-center bg-green-600 border-2 border-black rounded-md">
